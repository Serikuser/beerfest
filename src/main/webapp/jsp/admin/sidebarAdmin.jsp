...
<div class="sidebar-block_content profile-info">
    <div class="profile-info_item">
        <form action="controller" class="needs-validation" onsubmit="return cryptChange()" novalidate>
            ...
            <button type="submit" class="button_success button_width_100">Список пользователей</button>
        </form>
    </div>
    <div class="profile-info_item">
        <form action="controller" class="needs-validation" onsubmit="return cryptChange()" novalidate>
            ...
            <button type="submit" class="button_success button_width_100">Добавить новость</button>
        </form>
    </div>
</div>
