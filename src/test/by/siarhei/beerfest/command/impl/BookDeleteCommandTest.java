...
public class BookDeleteCommandTest {
    ...
    public Object[][] router() {
        return new Object[][]{
                {RoleType.ADMIN, new Router(JSP_MAIN)},
    ...
    @Test(
            dataProvider = "router",
            description = "case with role == GUEST, part of integration test" +
                    "command correct input data execution; " +
